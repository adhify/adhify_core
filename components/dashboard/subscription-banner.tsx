          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">
                {plan === "free" ? "Free Plan Limits" : `${plan.charAt(0).toUpperCase() + plan.slice(1)} Plan`}
              </p>
              <div className="mt-2 space-y-2">
                <div className="flex items-center gap-4 text-sm">
                  <span className="w-20">Projects:</span>
                  <div className="flex-1 max-w-32">
                    <Progress value={(usage.projects.current / usage.projects.limit) * 100} className="h-2" />
                  </div>
                ...
                <div className="flex items-center gap-4 text-sm">
                  ...
                  <div className="flex-1 max-w-32">
                    <Progress value={(usage.databases.current / usage.databases.limit) * 100} className="h-2" />
                  </div>
                  <span className="text-xs text-muted-foreground">
