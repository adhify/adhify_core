...
const mockProjects = [
  {
    ...
    deployments: [
      { id: "1", status: "SUCCESS", createdAt: new Date("2024-01-20") },
    ],
  },
  {
    id: "2",
    ...
    services: [],
    deployments: [
      { id: "2", status: "SUCCESS", createdAt: new Date("2024-01-18") },
    ],
  },
  {
    id: "3",
    ...
    deployments: [
      { id: "3", status: "FAILED", createdAt: new Date("2024-01-12") },
    ],
  },
];
...
export default function DashboardPage() {
  ...
  const runningResources = projects.reduce(
    (acc, project) => {
      const runningApps = project.apps.filter(
        (app) => app.status === "RUNNING",
      ).length;
      const runningDatabases = project.databases.filter(
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {runningResources.databases}
              </div>
              <p className="text-xs text-muted-foreground">
                of {totalResources.databases} total
              </p>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {runningResources.services}
              </div>
              <p className="text-xs text-muted-foreground">
                of {totalResources.services} total
              </p>
            </CardContent>
          </Card>
        </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {
                          project.apps.filter((app) => app.status === "RUNNING")
                            .length
                        }{" "}
                        / {project.apps.length}
                      </span>
